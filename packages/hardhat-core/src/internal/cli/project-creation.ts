...
function printSuggestedCommands(projectType: SampleProjectTypeCreationAction) {
  ...
  if (projectType === Action.CREATE_ADVANCED_SAMPLE_PROJECT_ACTION) {
    ...
    console.log(`  npx solhint '**/*.sol'`);
    console.log(`  npx solhint '**/*.sol' --fix`);
  }
}
